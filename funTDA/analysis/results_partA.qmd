...
#| fig-cap: "Representative subject (Symptomatic 1): H0/H1 persistence diagram (left) and H1 landscape λ₁(t) (right)."
...
of the variability among landscapes (PC1 ≈ `r sprintf("%.1f", pc1_pct)`%, PC2 ≈
