...
============================================================================
 ...
 WHAT COUNTS AS "THE CAVITY"  (settled before any group contrast was computed)
 -----------------------------------------------------------------------------
 ...
 This script writes the main definition and the sensitivity definition:
...
MAIN = [4, 43]            # body and atrium — the cavity, main definition
FULL = [4, 43, 5, 44]     # plus the temporal horns — the sensitivity definition
...
for s in sorted(meta):
    ...
    # sanity check: left and right must share one connected component
    big = sizes.argmax()
...
print("sensitivity definition are both reported, whatever they show.")
